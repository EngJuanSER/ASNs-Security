...
\begin{itemize}
    ...
    \item Investigación de ipapi.co para información de ASN/ISP
...
\subsubsection{Semana 3: Integración Nmap, NVD e ipapi.co (24-31 Octubre)}
\textbf{Objetivos:} Conectar escaneo de servicios con análisis de vulnerabilidades e información de ASN

\textbf{Actividades principales:}
\begin{itemize}
    \item Implementación de servicio de ejecución de Nmap mediante APIs de procesos del lenguaje
    \item Desarrollo de parser XML para output de Nmap
    \item Implementación de cliente REST para NVD API
    \item Implementación de cliente REST para ipapi.co (ASN/ISP)
...
\textbf{Actividades principales:}
\begin{itemize}
    \item Implementación de comparador de IPs lado a lado
    \item Desarrollo de funcionalidad de exportación (JSON, PDF)
    \item Mejora de visualizaciones (gráficos estadísticos, mapas interactivos)
    \item Implementación de historial de búsquedas con estadísticas
...
\begin{itemize}
    \item \textbf{Backend:} Java con Quarkus, arquitectura REST stateless
    \item \textbf{Escaneo y Análisis:} Nmap, NVD API, ipapi.co
    \item \textbf{Frontend:} Vue.js con TypeScript, librerías de mapas, cache local
    \item \textbf{Testing:} Framework de testing del lenguaje, herramientas de testing de APIs
    \item \textbf{Deployment:} Docker, plataformas cloud con tier gratuito
\end{itemize}
