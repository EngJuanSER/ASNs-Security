...
Este presupuesto está diseñado para un proyecto académico desarrollado por dos estudiantes universitarios durante un período de 8 se\begin{table}[H]
    \centering
    \small
    \begin{tabular}{|l|c|l|}
        \hline
        ...
        \hline
        Tiempo excesivo de escaneos Nmap & Media & Timeouts configurables, scope limitado \\
        \hline
        Necesidad de recursos adicionales & Baja & Todas las herramientas son gratuitas \\
        \hline
...
\end{table}en recursos realmente necesarios y aprovecha herramientas gratuitas y créditos académicos disponibles.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|r|}
        ...
        \hline
        Hosting básico & Servicio de hosting con créditos estudiantiles & \$0 \\
        \hline
        Nmap & Herramienta de código abierto (gratuita) & \$0 \\
        \hline
        NVD API & API pública de NIST (sin costo, sin API key) & \$0 \\
        \hline
        GeoLite2 & Base de datos gratuita de MaxMind & \$0 \\
        \hline
